            ...
            <div class="col-md-3">
                    <div class="card">
                        <div class="card-block">
                            ...
                            <h6 class="card-subtitle text-muted">$500.00</h6> <img src="images/iphone.jpg?url=images/iphone_big.jpg" class="dg-picture-zoom" class="img-fluid"> </div>
                        <div class="card-block">
                            <div class="card-text">Vous avez vraiment crue que j'allais remplir une description <a href="#" class="productItem btn btn-primary" data-name="Cable" data-s="1" data-price="50000" data-id="8">Ajouter au panier</a> </div>
                        </div>
                    </div>
                </div>
            </div>
